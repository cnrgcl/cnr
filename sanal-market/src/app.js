...
(function () {
  ...
  var RAFLAR = [
    { id:'A', tip:'gondol', x:-5.2, z:-2,  uzun:10,  en:1.4, yuz:{ eksi:'kahvaltilik', arti:'bakliyat' } },
    { id:'B', tip:'gondol', x:-0.5, z:-2,  uzun:10,  en:1.4, yuz:{ eksi:'atistirmalik', arti:'icecek' } },
    { id:'C', tip:'gondol', x: 5.0, z:-2,  uzun:10,  en:1.4, yuz:{ eksi:'temizlik', arti:'kagit' } },
  ...
  function magazaKur() {
    ...
    tavanMat = new T.MeshStandardMaterial({ color: '#F1F3F0', roughness: 0.95, side: T.DoubleSide });
